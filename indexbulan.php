...
$this_month = $_POST['bulan'];
$last_month = $this_month - 1;
$this_year = $_POST['tahun'];
?>
            ...
            <section class="content-header">
              <h1>
                ...
                <small>
                  ...
                  <div class="col-sm-2" style="margin-right:-50px;">
                    <div class="form-group">
                      <select name="bulan" id="ruangan" class="form-control" data-placeholder="Pilih Bulan" style="width: 80%;">
                        <option value="01" <?php if("01"==$this_month){echo "selected";} ?>>Januari</option>
                        <option value="02" <?php if("02"==$this_month){echo "selected";} ?>>Februari</option>
                        <option value="03" <?php if("03"==$this_month){echo "selected";} ?>>Maret</option>
                        <option value="04" <?php if("04"==$this_month){echo "selected";} ?>>April</option>
                        <option value="05" <?php if("05"==$this_month){echo "selected";} ?>>Mei</option>
                        <option value="06" <?php if("06"==$this_month){echo "selected";} ?>>Juni</option>
                        <option value="07" <?php if("07"==$this_month){echo "selected";} ?>>Juli</option>
                        <option value="08" <?php if("08"==$this_month){echo "selected";} ?>>Agustus</option>
                        <option value="09" <?php if("09"==$this_month){echo "selected";} ?>>September</option>
                        <option value="10" <?php if("10"==$this_month){echo "selected";} ?>>Oktober</option>
                        <option value="11" <?php if("11"==$this_month){echo "selected";} ?>>November</option>
                        <option value="12" <?php if("12"==$this_month){echo "selected";} ?>>Desember</option>
                      </select>
                    </div> <!-- /.form-group -->
                  </div>
                  <div class="col-sm-1">
                    <div class="form-group">
                      <select name="tahun" id="ruangan" class="form-control" data-placeholder="Pilih Tahun" style="width: 140%;">
                        ...
                        for($i = $mulai;$i<$mulai+5;$i++){
                          $sel = $i == $this_year ? ' selected="selected"' : '';
                  ...
                  <div class="col-sm-1">
                    <!-- <a href="index-bulan.php?bulan=<?php echo $_GET['bulan']; ?>&&tahun=<?php echo $_GET['tahun']; ?>" class="btn btn-sm btn-primary btn-flat pull-right" style="border-color:gray;">Proses</a> -->
                  ...
                  <div class="col-sm-2">
                    ...
                    <!-- <button class="btn btn-primary" type="submit" style="border-color:gray;">Lihat Bulan Ini</button> -->
                  </div>
                  <div class="col-sm-1">
