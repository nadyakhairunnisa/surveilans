...
$id=$_GET['id'];
$data = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM surv_gejala_ido WHERE id_surv_gejala = $id"));
          ...
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="process/add-surveilans-ido.php" align="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="date" name="infeksiDate" class="form-control" value="<?php echo $data['tanggal_kejadian'] ?>" required>
                </div>
              </div>
                ...
                <div class="col-sm-9">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="drainase" value="Drainase" <?php in_array ('Drainase', $tanda) ? print "checked" : ""; ?>>Drainase
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="perforasi" value="Perforasi" <?php in_array ('Perforasi', $tanda) ? print "checked" : ""; ?>>Perforasi
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="fistula" value="Fistula" <?php in_array ('Fistula', $tanda) ? print "checked" : ""; ?>>Fistula
                        </label>
                      </div>
                    </div>
                  </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea name="keterangan" rows="3" class="form-control"><?php echo $data['keterangan_infeksi'] ?></textarea>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="row">
                    <div class="col-sm-3">
                      <input type="date" name="dateKultur" class="form-control" value="<?php echo $data['tanggal_kultur'] ?>">
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="hasilKultur" value="<?php echo $data['hasil_kultur'] ?>" class="form-control">
                    </div>
                  </div>
                </div>
              </div><br> <!-- /.form-group -->
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <a class="btn btn-danger btn-block" href="process/delete-surveilans-ido.php?id=<?php echo $id; ?>"><div onclick="return konfirmasi_hapus()" >Hapus</div></a>
                  </div>
                </div>
              </div>
