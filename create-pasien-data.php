      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="process/add-pasien-data.php" align="">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <label class="radio-inline">
                        <input type="radio" name="gender" id="femaleRadio" value="Perempuan" checked>Perempuan
                      </label>
                    </div>
                    <div class="col-sm-3">
                      <label class="radio-inline">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea name="alamat" placeholder="Masukkan Alamat ..." rows="3" class="form-control" required></textarea>
                </div>
              </div>
