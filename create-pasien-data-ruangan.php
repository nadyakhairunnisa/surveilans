      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" role="form" method="post" action="process/add-pasien-data-ruangan.php" align="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="date" name="inDate" class="form-control" value="<?php echo $data['tanggal_masuk_rs']; ?>" required>
                </div>
              </div>
              <div class="form-group">
