              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <label class="radio-inline">
                        <input type="radio" name="lokasi" id="taki" value="Ta-Ki">Tangan Kiri
                      </label>
                    </div>
                    <div class="col-sm-3">
                      <label class="radio-inline">
                        <input type="radio" name="lokasi" id="kaka" value="Ka-Ka">Kaki Kanan
                      </label>
                    </div>
                    <div class="col-sm-3">
                      <label class="radio-inline">
                        <input type="radio" name="lokasi" id="kaki" value="Ka-Ki">Kaki Kiri
                      </label>
                    </div>
                  </div>
                </div>
