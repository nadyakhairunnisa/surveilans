          ...
          <div class="row">
            <section class="content-header">
              <h1>
                ...
                <small>
                  <div class="col-sm-2" style="margin-right:-50px;width:15%">
                  ...
                  <div class="col-sm-2">
                    ...
                    <a href="index.php" class="btn btn-sm btn-default btn-flat pull-right" style="border-color:gray;">Lihat Dashboard Bulanan</a>
                  </div>
                </small>
              </h1>
            </section>
        ...
        <div class="harian">
            ...
            <div class="box box-default">
              <div class="box-body">
                <div class="box-header with-border">
                  <h3 class="box-title">Berdasarkan Ruang Rawat Inap (Harian)</h3>          
                </div><br>
          ...
          <div class="col-md-6">
            ...
            <div class="box box-default">
              <div class="box-body">
                <div class="box-header with-border">
                  <h3 class="box-title">Berdasarkan Jenis Infeksi (Harian)</h3>          
                </div><br>
                <div class="col-lg-3 col-xs-6">
                  <!-- small box -->
                  <div class="small-box bg-red" id="index-chart">
