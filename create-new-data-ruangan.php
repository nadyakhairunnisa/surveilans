  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-plus-circle"></i>Tambah Data Ruangan</a></li>
        </ol>
      </section>
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" role="form" method="post" action="process/add-new-data-ruangan.php" align="">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <!-- <div class="col-sm-3">
                    <a class="btn btn-danger btn-block" href="process/delete-data-ruangan.php?id=<?php echo $id; ?>">Hapus</a>
                  </div> -->
                </div>
              </div>
            </form> <!-- /form -->
