...
$norm = $_GET['id'];
$data = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM identitas_pasien WHERE no_rm = $norm"));
?>
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="process/edit-data-pasien.php" align="">
              ...
              <input type="hidden" value="stepform" name="type">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="hidden" name="oldnorm" value="<?php echo $norm ?>" class="form-control">
                  <input type="text" name="newnorm" value="<?php echo $norm ?>" class="form-control" required autofocus>
                </div>
              </div>
              <div class="form-group">
                <label for="firstName" class="col-sm-2 control-label">Nama Lengkap</label>
                <div class="col-sm-9">
                  <input type="text" name="nama" value="<?php echo $data['nama_pasien'] ?>" class="form-control" required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea name="alamat" rows="3" class="form-control" required><?php echo $data['alamat'] ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-9 col-sm-offset-2">
                  ...
                  <!-- <a class="btn btn-primary btn-block" href="create-pasien-data-keadaan.php">Selanjutnya</a> -->
                </div>
              </div>
