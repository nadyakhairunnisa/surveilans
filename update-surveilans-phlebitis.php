...
$id=$_GET['id'];
$data = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM surv_gejala_phlebitis WHERE id_surv_gejala = $id"));
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          TAMBAH DATA
          <small>Surveilans Phlebitis</small>
        </h1>
        <ol class="breadcrumb">
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="process/edit-surveilans-phlebitis.php" align="">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2">Lakukan Kebersihan Tangan Sebelum dan Sesudah Pemasangan</label>
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles1" id="ya" value="Ya" <?php if($data['bundles_kebersihan'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles1" id="tidak" value="Tidak" <?php if($data['bundles_kebersihan'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>    
                <label class="control-label col-sm-2">Melepas Pemasangan Apabila Ada Keluhan/Peradangan</label>
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles2" id="ya" value="Ya" <?php if($data['bundles_lepas_bykeluhan'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles2" id="tidak" value="Tidak" <?php if($data['bundles_lepas_bykeluhan'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label class="control-label col-sm-2">Lakukan Pengecekan Balutan Pemasangan (Drayssing)</label>
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles3" id="ya" value="Ya" <?php if($data['bundles_cek_balutan'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles3" id="tidak" value="Tidak" <?php if($data['bundles_cek_balutan'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
                <label class="control-label col-sm-2">Melepas Pemasangan Apabila Lebih dari 72 Jam</label>
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles4" id="ya" value="Ya" <?php if($data['bundles_lepas_bywaktu'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles4" id="tidak" value="Tidak" <?php if($data['bundles_lepas_bywaktu'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                <label class="control-label col-sm-2">Lakukan Pengecekan Tempat Pemasangan</label>
                <div class="col-sm-4">
                  <div class="row">
                    <div class="col-sm-3">
                      <label class="radio-inline">
                        <input type="radio" name="bundles5" id="ya" value="Ya" <?php if($data['bundles_cek_tempat'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-3">
                      <label class="radio-inline">
                        <input type="radio" name="bundles5" id="tidak" value="Tidak" <?php if($data['bundles_cek_tempat'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <a class="btn btn-danger btn-block" href="process/delete-surveilans-phlebitis.php?id=<?php echo $id; ?>"><div onclick="return konfirmasi_hapus()" >Hapus</div></a>
                  </div>
                </div>
              </div>
