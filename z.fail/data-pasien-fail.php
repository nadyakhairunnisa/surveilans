              ...
              <div class="box-body">
                <table id="example1" class="table table-bordered table-striped" style="border-color:#dbdbdb">
                  ...
                  <tbody>
                    ...
                    <?php 
                    $result = mysqli_query($conn, "SELECT * FROM identitas_pasien ip JOIN keadaan_pasien kp ON (ip.no_rm = kp.no_rm) JOIN pemakaian_ruangan pr ON (pr.id_keadaan = kp.id_keadaan)");
