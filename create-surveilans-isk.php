      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="process/add-surveilans-isk.php" align="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles6" id="ya" value="Ya" checked>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles6" id="tidak" value="Tidak">Tidak
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles7" id="ya" value="Ya" checked>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles7" id="tidak" value="Tidak">Tidak
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles8" id="ya" value="Ya" checked>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles8" id="tidak" value="Tidak">Tidak
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="terjadi" id="terjadi" class="form-control select2" required>
