      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="process/add-surveilans-iadp.php" align="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select id="tanda" name="terjadi" class="form-control select2" required>
