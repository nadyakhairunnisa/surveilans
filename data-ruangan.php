        ...
        <ul class="sidebar-menu" data-widget="tree" >
          ...
          <li class="active treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="#"><i class="fa fa-circle-o"></i>Ruangan</a></li>
            </ul>
          </li>
      ...
      <section class="content container-fluid">
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="process/add-ruangan.php" align="">

              <div class="box-header">
                <h3 class="box-title" style="text-decoration:underline;">Tambah Ruangan</h3>          
              </div>
              <!-- /.box-header -->

              <div class="form-group">
                <label for="firstName" class="col-sm-2 control-label">Nama Ruangan</label>
                <div class="col-sm-5">
                  <input type="text" name="nama" placeholder="Ruangan" class="form-control" autofocus>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-2 col-sm-offset-3">
                  ...
                  <!-- <a class="btn btn-primary btn-block" href="data-ruangan.php">Submit</a> -->
                </div>
              </div>
          ...
          <div class="box-body" style="width: 70%; background-color:transparent;">
            <div class="box-header">
              <h3 class="box-title" style="text-decoration:underline;">Tabel Ruangan</h3>
            </div>
            <div class="box-header">
                ...
                <tbody>
                  ...
                  <td><?php echo $row['nama_ruangan']; ?></td>
                    <td style='font-size:20px'>
                      ...
                      <div class='col-sm-1'><a href='process/delete-ruangan.php?id=<?php echo $row['kode_ruangan']; ?>'><div onclick="return konfirmasi_hapus()" ><i class='fa fa-trash-o'></i></div></a></div>
                    </td>
                  </tr>
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form class="form-horizontal" role="form" method="post" action="process/edit-ruangan.php" align="">
                            <input type="hidden" value="<?php echo $row['kode_ruangan']; ?>" name="id">
                            <div class="form-group">
                              <label for="firstName" class="col-sm-3 control-label">Nama Ruangan</label>
                              <div class="col-sm-5">
                                <input type="text" name="nama" value=<?php echo $row['nama_ruangan']; ?> class="form-control" autofocus>
                              </div>
                            </div><br><br>
                            <!-- /form -->
                            <div class="form-group">
                              <div class="col-sm-2 col-sm-offset-3">
                                <button type="submit" class="btn btn-primary btn-block">Submit</button>
                                <!-- <a class="btn btn-primary btn-block" href="data-ruangan.php">Edit</a> -->
                              </div>
                            </div>
                          </form><br>
                          <!-- /form -->
