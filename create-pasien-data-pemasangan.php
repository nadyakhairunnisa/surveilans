...
<body class="hold-transition skin-green-light sidebar-mini">
          ...
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" role="form" method="post" action="process/add-pemasangan.php">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <select id="pasang" name="pasang" class="form-control select2">
                    <option value="" selected disabled>Pilih Jenis Surveilans</option>
                    <option value="phlebitis">Phlebitis</option>
                    <option value="iadp">IADP</option>
                    <option value="isk">Infeksi Saluran Kemih (ISK)</option>
                    <option value="vap">Ventilator Associated Pneumonia (VAP)</option>
                    <option value="ido">Infeksi Daerah Operasi (IDO)</option>
                    <!-- <option value="pemantauan">Pemantauan Luka</option> -->
                    <option value="antibiotik">Pemakaian Antibiotik</option>
  ...
  <script>
    ...
    var cache = {};
    var jenisLama = $("#pasang").val();
    $("#pasang").change(function(){
      var input = $(this);

      var jenisBaru = input.val();

      var form = $("#form-pemasangan");
      cache[jenisLama] = form.clone();

      if (cache[jenisBaru]) {
        form.replaceWith(cache[jenisBaru]);
      } else {
        form.load("content/form-pemasangan-"+jenisBaru+".php");
      }
      jenisLama = jenisBaru;
    });
  })
