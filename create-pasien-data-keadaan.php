      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="process/add-pasien-data-keadaan.php" align="">

              <input type="hidden" value="<?php echo $norm; ?>" name="norm">
                  ...
                  <div class="row">
                    <div class="col-sm-2">
                      <label class="radio-inline">
                        <input type="radio" name="caramasuk" id="IGDradio" value="IGD" checked>IGD
                      </label>
                    </div>
                    <div class="col-sm-2">
                      <label class="radio-inline">
                        <input type="radio" name="caramasuk" id="IRJradio" value="IRJ">IRJ
                      </label>
                    </div>
                    <div class="col-sm-3">
                      <label class="radio-inline">
                        <input type="radio" name="caramasuk" id="LangsungRadio" value="Langsung">Langsung
                      </label>
                    </div>
                    <div class="col-sm-3">
                      <label class="radio-inline">
                        <input type="radio" name="caramasuk" id="RujukanRadio" value="Rujukan">Rujukan
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <label class="radio-inline">
                        <input type="radio" name="keadaan" id="MeninggalRad" value="Meninggal">Meninggal
                      </label>
                    </div>
                    <div class="col-sm-2">
                      <label class="radio-inline">
                        <input type="radio" name="keadaan" id="KaburRad" value="Kabur">Kabur
                      </label>
                    </div>
                    <div class="col-sm-2">
                      <label class="radio-inline">
                        <input type="radio" name="keadaan" id="PindahRad" value="Pindah RS">Pindah RS
                      </label>
                    </div>
                    <div class="col-sm-2">
                      <label class="radio-inline">
                        <input type="radio" name="keadaan" id="PPradio" value="PP">PP
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-9">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="faktor[]" id="obesitas" value="Obesitas">Obesitas
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="faktor[]" id="faalhati" value="Gangguan Faal Hati">Gangguan Faal Hati
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="faktor[]" id="faalginjal" value="Gangguan Faal Ginjal">Gangguan Faal Ginjal
                        </label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-3">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="faktor[]" id="perokok" value="Perokok">Perokok
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="faktor[]" id="giziburuk" value="Gizi Buruk">Gizi Buruk
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="faktor[]" id="gangguansistemimun" value="Gangguan Sistem Kekebalan Tubuh">Gangguan Sistem Kekebalan Tubuh
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="faktor[]" id="keganasan" value="Keganasan">Keganasan
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="faktor[]" id="bayi" value="Bayi, partus normal">Bayi, partus normal
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-3">
