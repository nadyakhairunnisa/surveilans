...
$id=$_GET['id'];
$data = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM surv_gejala_isk WHERE id_surv_gejala = $id"));
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-body">
            ...
            <form class="form-horizontal" role="form" method="post" action="process/edit-surveilans-isk.php" align="">
              ...
              <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles1" id="ya" value="Ya" <?php if($data['bundles_pemasangan_dc'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles1" id="tidak" value="Tidak" <?php if($data['bundles_pemasangan_dc'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>    
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles2" id="ya" value="Ya" <?php if($data['bundles_alat_steril'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles2" id="tidak" value="Tidak" <?php if($data['bundles_alat_steril'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles3" id="ya" value="Ya" <?php if($data['bundles_handhygiene'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles3" id="tidak" value="Tidak" <?php if($data['bundles_handhygiene'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles4" id="ya" value="Ya" <?php if($data['bundles_lepas_noindikasi'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles4" id="tidak" value="Tidak" <?php if($data['bundles_lepas_noindikasi'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles5" id="ya" value="Ya" <?php if($data['bundles_fiksasi'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles5" id="tidak" value="Tidak" <?php if($data['bundles_fiksasi'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles6" id="ya" value="Ya" <?php if($data['bundles_balon'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles6" id="tidak" value="Tidak" <?php if($data['bundles_balon'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles7" id="ya" value="Ya" <?php if($data['bundles_adp'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles7" id="tidak" value="Tidak" <?php if($data['bundles_adp'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-3">
                  <div class="row">
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles8" id="ya" value="Ya" <?php if($data['bundles_urinebag'] == "Ya"){echo "checked";} ?>>Ya
                      </label>
                    </div>
                    <div class="col-sm-4">
                      <label class="radio-inline">
                        <input type="radio" name="bundles8" id="tidak" value="Tidak" <?php if($data['bundles_urinebag'] == "Tidak"){echo "checked";} ?>>Tidak
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-10">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="suhu" value="Suhu <37C" <?php in_array ('Suhu >38C', $tanda) ? print "checked" : ""; ?>>Suhu <37C
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="sistolik" value="Nadi <100/m" <?php in_array ('Suhu >38C', $tanda) ? print "checked" : ""; ?>>Frek. Nadi <100/m
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="apnu" value="Apnu" <?php in_array ('Apnu', $tanda) ? print "checked" : ""; ?>>Apnu
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="Pus" value="Pus" <?php in_array ('Apnu', $tanda) ? print "checked" : ""; ?>>Pus
                        </label>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="Letargi" value="Letargi" <?php in_array ('Letargi', $tanda) ? print "checked" : ""; ?>>Letargi
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="Muntah" value="Muntah" <?php in_array ('Muntah', $tanda) ? print "checked" : ""; ?>>Muntah
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="Anyang-anyangan" value="Anyang-anyangan" <?php in_array ('Anyang-anyangan', $tanda) ? print "checked" : ""; ?>>Anyang-anyangan
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="tanda[]" id="Nyeri-Supra-Publik" value="Nyeri Supra Publik" <?php in_array ('Nyeri Supra Publik', $tanda) ? print "checked" : ""; ?>>Nyeri Supra Publik
                        </label>
                      </div>
                    </div>
                    <div class="col-sm-2">
